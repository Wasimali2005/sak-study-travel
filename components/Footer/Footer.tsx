        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            <a
              ...
              href="https://www.facebook.com/share/1857BNt9zY/" target="_blank" rel="noopener noreferrer"
            >
            ...
            <a
              className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-surface-variant/80 hover:text-white hover:bg-primary-container transition-all duration-300 hover:-translate-y-1"
              href="https://www.instagram.com/tech4edgesofficial?igsh=YzZoNnVubHkzMnlv" target="_blank" rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a
              className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-surface-variant/80 hover:text-white hover:bg-primary-container transition-all duration-300 hover:-translate-y-1"
              href="https://www.linkedin.com/company/tech4edges/" target="_blank" rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <ul className="space-y-4 text-surface-variant/80 text-sm">
            <li>
              <a href="https://maps.app.goo.gl/CRy43GJPC4nXtCwo6?g_st=aw" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 hover:text-white transition-colors duration-300 group">
                ...
                <span>Office No. 322 (A), Block D, 3rd Floor, Sami Tower, Ring Road, Peshawar</span>
              </a>
            </li>
            <li>
